<template>
  <div>
    <nav-top></nav-top>
    <el-page-header @back="goBack" content="查看视频" class="p-3" style="box-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1)"></el-page-header>
    <b-container>
      ...
      <b-row no-gutters class="mb-1">
       ...
       <p class="article-date">发布于 2022-09-15 0：56</p>
       <!-- 评论组件 -->
       <yx-remarks :remarksInfo="remarksInfo"></yx-remarks>
    </b-container>
  </div>
</template>
...
created(){
  this.video.url=this.$route.query.url;
}
